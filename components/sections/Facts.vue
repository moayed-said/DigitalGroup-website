<template>
    <section :class="`w-screen p-4 lg:h-[300px] bg-no-repeat bg-cover bg-blue-900 bg-blend-multiply`" :style="`background-image: url(${$config.app.baseURL}images/facts-bg.png)`">
